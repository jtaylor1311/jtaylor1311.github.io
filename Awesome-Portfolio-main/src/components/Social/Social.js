    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/jtaylor1311" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/socialtedium/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/james-taylor-kelly-91b737113/" />
                <IconBtn icon={Email} m={1} href="mailto:jtaylor1311@gmail.com" />
            </div>
        );
    } else {
        return (
